...
function Footer() {
  ...
  <div className="mx-auto max-w-5xl justify-center text-center flex flex-col items-center px-4 py-16 sm:px-6 lg:px-8">
    ...
    <ul className="mt-12 flex justify-center gap-6 md:gap-8">
      <li>
        <a
          href="https://www.facebook.com/umer.sufian.1?mibextid=ZbWKwL"
          rel="noreferrer"
          target="_blank"
      ...
      <li>
        <a
          href="https://www.instagram.com/_u.m.e.r._x?igsh=dGlpOWU0NjBhNnk3"
          rel="noreferrer"
          target="_blank"
          className="text-gray-700 transition hover:text-gray-700/75"
        >
      ...
      <li>
        <a
          href="https://x.com/umersufian02?t=I7lzhmqTRAiN3jMYxSKdyw&s=09"
          rel="noreferrer"
          target="_blank"
          className="text-gray-700 transition hover:text-gray-700/75"
        >
      ...
      <li>
        <a
          href="https://github.com/UmerSufian"
          rel="noreferrer"
          target="_blank"
          className="text-gray-700 transition hover:text-gray-700/75"
        >
