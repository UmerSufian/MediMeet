...
function CategorySearch() {
  ...
  return (
    <div className='mb-10 items-center px-5 flex flex-col gap-2'>
        ...
        <h2 className='text-gray-500 text-xl'>Search Your Doctor and Book Appoinment in one click</h2>
        ...
        <Button type="submit">
            ...
            <div className='grid grid-cols-3 mt-5 md:grid-cols-4 lg:grid-col-6'>
        ...
        [1,2,3,4,5,6].map((item,index)=>(
            <div className=' bg-slate-200 m-2 w-[130px] h-[120px] animate-pulse rounded-lg' key={index}>
